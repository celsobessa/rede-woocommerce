...
RUN wget https://downloads.wordpress.org/plugin/woocommerce.3.6.3.zip -P /var/www
RUN unzip /var/www/woocommerce.3.6.3.zip -d /var/www/html/wp-content/plugins

RUN wget https://github.com/DevelopersRede/woocommerce/releases/download/1.1.2/rede-woocommerce.zip -P /var/www
RUN unzip /var/www/rede-woocommerce.zip -d /var/www/html/wp-content/plugins
RUN rm /var/www/*.zip
